...
class spos 
{
	public static void main(String args[]) throws NullPointerException, FileNotFoundException
	{
	 ...
	 String line; 
	 try{
		 BufferedReader br=new BufferedReader(new FileReader("/home/aditya/simp11/sample.txt"));
		 BufferedWriter bw=new BufferedWriter(new FileWriter("/home/aditya/simp11/Output1.txt"));
	 ...
	 BufferedReader br=new BufferedReader(new FileReader("/home/aditya/simp11/Output1.txt"));
	 System.out.println("\n***********************Output1.txt***********************\n");
	 try {
